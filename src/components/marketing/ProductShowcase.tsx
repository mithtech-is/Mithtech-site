        ...
        <div className="flex flex-col w-full min-h-screen bg-background">
            ...
            <section className="relative py-24 lg:py-32 overflow-hidden border-b">
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col items-center text-center max-w-4xl mx-auto w-full px-2">
                        <motion.div
                        ...
                        >
                            ...
                            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-6xl mb-6 text-foreground break-words w-full px-2">
                                {product.title}
                            </h1>
                            ...
                            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-10 max-w-2xl mx-auto break-words px-4">
            ...
            <section id="use-case" className="py-24 border-b bg-muted/20">
                <div className="container mx-auto">
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <h2 className="text-3xl font-bold mb-8 break-words sm:text-4xl">How it works in action</h2>
                        <div className="bg-background border rounded-[2.5rem] p-6 sm:p-10 shadow-xl overflow-hidden relative">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full -translate-y-1/2 translate-x-1/2 -z-0" />
                            <div className="relative z-10">
                                <p className="text-xl sm:text-2xl leading-relaxed text-foreground/80 mb-10 italic font-medium break-words">
                                    &quot;{product.useCase}&quot;
                                </p>
                                
                                {product.slug === 'polygin' && (
                                    <div className="mt-12 p-6 sm:p-8 bg-muted/40 rounded-3xl border border-primary/10 flex flex-col md:flex-row items-center gap-8">
                                        ...
                                        <Button asChild className="h-14 px-8 rounded-full shadow-xl w-full md:w-auto">
                                            <a
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="w-full">
                            <h2 className="text-2xl font-bold mb-8 sm:text-3xl break-words">
                            ...
                            <div className="grid gap-6">
                                {product.features.map((feature, index) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-lg break-words">{feature}</h3>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
                        ...
                        >
                            ...
                            <div className="relative z-10 text-center p-6 sm:p-8 w-full">
                                ...
                                <h3 className="text-xl font-bold text-white mb-4 sm:text-2xl break-words">
                                    {isProprietary ? 'Ready to get started?' : `Need help with ${product.title}?`}
                                </h3>
                                <p className="text-white/70 mb-8 max-w-sm mx-auto text-sm sm:text-base">
                                    {isProprietary
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
                                    {product.externalHref && (
                                        <Button asChild variant="outline" className="rounded-full px-8 h-12 text-base font-medium border-white text-white hover:bg-white hover:text-black w-full sm:w-auto">
                                            <a href={product.externalHref} target="_blank" rel="noopener noreferrer">
                                                Visit Official {product.title}
                                            </a>
                                        </Button>
                                    )}
                                    <Button asChild variant={product.externalHref ? "outline" : "secondary"} className={`rounded-full px-8 h-12 text-base font-medium ${product.externalHref ? 'text-white border-white hover:bg-white hover:text-black' : ''} transition-colors w-full sm:w-auto`}>
