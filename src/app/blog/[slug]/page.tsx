...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
    ...
    return {
        title: `${post.title} | Mith Tech Blog`,
        description: post.description,
        keywords: [post.category, "ERPNext", "Mith Tech", "open source ERP India", "Frappe development"],
        alternates: {
            canonical: `https://mith.tech/blog/${post.slug}`,
        },
        openGraph: {
            title: post.title,
            description: post.description,
    ...
    const jsonLd = [
        {
            ...
            "publisher": {
                ...
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://mith.tech/assets/logo.png"
                }
            },
            "mainEntityOfPage": {
                "@type": "WebPage",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://mith.tech/blog" },
                { "@type": "ListItem", "position": 3, "name": post.title, "item": `https://mith.tech/blog/${post.slug}` }
            ]
        }
    ];
