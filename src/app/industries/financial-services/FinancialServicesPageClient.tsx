                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl mb-10">
                            Modernise your NBFC, lending firm, or financial institution with digital platforms that automate loan workflows, enforce compliance, and scale your portfolio without scaling your headcount.
                        </p>
            ...
            <section className="py-16 sm:py-20 md:py-24 border-b">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-4xl font-black tracking-tight mb-4">Built for high-compliance, high-volume finance</h2>
                        <p className="text-lg text-muted-foreground">Every platform we configure is designed to handle the regulatory and operational complexity of modern financial services.</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <FeatureBox icon={ClipboardList} title="Loan Origination" description="Digitise your end-to-end loan application process—from online application and document collection to credit assessment and disbursement." />
                        <FeatureBox icon={ShieldCheck} title="KYC Automation" description="Streamline identity verification, document collection, and risk screening with automated KYC workflows that are audit-ready." />
                        <FeatureBox icon={Database} title="Portfolio Management" description="Track active loans, EMI schedules, overdue accounts, and collections performance across your entire lending portfolio in real time." />
                        <FeatureBox icon={BarChart3} title="Regulatory Reporting" description="Generate compliance-ready reports for RBI, SEBI, or other regulators with automated data extraction and formatted output." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 sm:py-20 md:py-24 border-b">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="mb-16">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl">We build a connected financial operating system using Frappe, ERPNext, and n8n—tailored to your product types, customer segments, and compliance obligations.</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "A fully customised loan application portal covering lead capture, document submission, credit evaluation, approval workflows, and digital agreement execution.",
                                points: ["Online loan application portal", "Document upload & verification", "Multi-level approval workflows", "Digital agreement & e-signatures"],
                            },
                            {
                                icon: Database,
                                title: "Loan Management System (LMS)",
                                desc: "Track disbursed loans from day one to closure—EMI schedules, payment tracking, overdue management, foreclosure, and NOC generation.",
                                points: ["EMI schedule generation", "Payment tracking & reconciliation", "Overdue & collections workflow", "NOC & closure processing"],
                            },
                            {
                                icon: TrendingUp,
                                title: "Portfolio & Risk Analytics",
                                desc: "Get a real-time view of your lending portfolio health—NPA rates, collection efficiency, product-wise performance, and branch-level dashboards.",
                                points: ["Portfolio at risk (PAR) tracking", "Collection efficiency reports", "Branch & product-wise P&L", "Regulatory submission reports"],
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            {[
                                { stat: "60%", label: "Faster loan processing time with automated origination workflows" },
                                { stat: "3×", label: "More applications handled per credit analyst vs manual systems" },
                                { stat: "40%", label: "Improvement in collection efficiency with automated follow-ups" },
                                { stat: "100%", label: "Audit-ready data—complete trail of every decision and document" },
                            ].map((item, i) => (
