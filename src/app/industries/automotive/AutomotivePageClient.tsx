                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-black tracking-tighter sm:text-5xl md:text-6xl lg:text-8xl text-foreground mb-8 leading-[0.9]">
                            AUTOMOTIVE &<br />
                            <span className="text-muted-foreground">CAR CARE</span>
                        </h1>
                        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-2xl mb-10">
                            Transform your workshop, detailing studio, or multi-location car care chain with platforms purpose-built for speed, service quality, and customer retention.
                        </p>
            ...
            <section className="py-16 sm:py-20 md:py-24 border-b">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <h2 className="text-4xl font-black tracking-tight mb-4">Everything your workshop needs</h2>
                        <p className="text-lg text-muted-foreground">From the first booking to the final invoice—every touchpoint, digitised and automated.</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <FeatureBox icon={CalendarCheck} title="Online Service Booking" description="Let customers book oil changes, detailing packages, and tyre services 24/7 from any device, with real-time slot availability." />
                        <FeatureBox icon={Package} title="Parts & Inventory" description="Track every part in your workshop—from filters to paint supplies—with automated reorder alerts and supplier management." />
                        <FeatureBox icon={Users} title="Customer CRM" description="Maintain full service histories for every vehicle, enabling upsells, service reminders, and personalised loyalty campaigns." />
                        <FeatureBox icon={BarChart3} title="Revenue Dashboards" description="Monitor daily revenue, technician efficiency, job completion rates, and customer retention from a single real-time dashboard." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 sm:py-20 md:py-24 border-b">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="mb-16">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl">We integrate proven open-source platforms into a cohesive, branded system that your team will actually use.</p>
                    </div>
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 sm:gap-8">
                        {[
                            {
                                icon: CalendarCheck,
                                title: "Schedulr Booking Engine",
                                desc: "Deploy a white-labelled appointment system on your website that handles service categories, technician allocation, and automated SMS/email reminders.",
                                points: ["Custom service menus", "Multi-technician scheduling", "Automated confirmations & reminders", "Prepayment & deposit support"],
                            },
                            {
                                icon: ClipboardList,
                                title: "ERPNext Workshop Module",
                                desc: "A full back-office ERP covering job cards, parts procurement, invoice generation, and financial reporting—designed for automotive service businesses.",
                                points: ["Job card & service order management", "Parts purchasing & stock control", "GST-ready invoicing", "Multi-branch support"],
                            },
                            {
                                icon: Star,
                                title: "Loyalty & Marketing Automation",
                                desc: "Drive repeat visits with automated loyalty programmes, service anniversary emails, and seasonal campaign flows powered by Mautic.",
                                points: ["Point-based loyalty system", "Personalised service reminders", "WhatsApp & email campaigns", "Customer segmentation"],
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            {[
                                { stat: "40%", label: "Reduction in no-show bookings with automated reminders" },
                                ...
                                { stat: "100%", label: "Data ownership—your customer data, your servers" },
                            ].map((item, i) => (
