    ...
    return (
        <div className="flex flex-col w-full bg-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="inline-flex items-center gap-2 rounded-full border border-black/5 bg-black/[0.02] px-3 py-1 mb-8">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-black/40">Sector: Real Estate</span>
                        </div>
                        <h1 className="text-3xl font-extrabold tracking-tight text-black sm:text-7xl lg:text-8xl mb-8 leading-[0.9] uppercase break-words">
                            Close more <br /> 
                            <span className="text-[#00aaff]">Deals.</span>
                        </h1>
                        <p className="text-xl leading-loose text-black/50 max-w-3xl mx-auto mb-12 italic">
                            Give your agents, developers, and property managers the digital infrastructure 
                            they need to manage more listings, automate client follow-ups, 
                            and delight more clients—closing deals at scale.
                        </p>
            ...
            <section className="py-12 sm:py-24 border-y border-black/[0.05] bg-black/[0.01]">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <h2 className="text-5xl font-extrabold tracking-tight text-black mb-8 uppercase">Your entire agency, connected</h2>
                        <p className="text-xl text-black/40 leading-loose italic max-w-2xl mx-auto">From first inquiry to final key handover—streamline every stage of the property journey.</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <FeatureBox icon={Search} title="Listing Central" description="Publish and syndicate property listings across your website and portals from a single dashboard." />
                        <FeatureBox icon={Users} title="Agent CRM" description="Track every lead and enquiry across your entire team with reminders and automated deal scoring." />
                        <FeatureBox icon={FileText} title="Smart Workflows" description="Automate agreement generation and digital signing across your entire portfolio of transactions." />
                        <FeatureBox icon={BarChart3} title="Growth Analytics" description="Monitor agent productivity and revenue forecasting with real-time performance dashboards." />
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-24 lg:py-32 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-20">
                        <h2 className="text-4xl font-extrabold tracking-tight text-black mb-8 uppercase">The Real Estate Stack</h2>
                        <p className="text-xl text-black/40 max-w-2xl">Unified property platforms customised to your agency's unique internal workflows.</p>
                    </div>
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
                        {[
                            {
                                icon: Globe,
                                title: "Directorist Portal",
                                desc: "Build a branded property listing portal with advanced search, geo-filters, maps, and agent profiles.",
                                points: ["Advanced geo-filtering", "Property comparison tools", "Agent & developer profiles", "Automatic inquiry capture"],
                            },
                            {
                                icon: Users,
                                title: "Perfex for Agency",
                                desc: "Complete CRM configured for real estate: lead assignment, pipeline stages, and proposal generation.",
                                points: ["Custom property pipelines", "Agent performance tracking", "Follow-up automation", "Client portal access"],
                            },
                            {
                                icon: Mail,
                                title: "Nurture Campaigns",
                                desc: "Nurture leads automatically with drip campaigns, new listing alerts, and open-house invitations.",
                                points: ["New listing email alerts", "Lead scoring & segmentation", "WhatsApp inquiry automation", "Market report workflows"],
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                        ...
                        <div className="flex flex-col lg:flex-row gap-20 items-center">
                            <div className="flex-1">
                                <h2 className="text-5xl font-extrabold mb-12 leading-tight tracking-tight">
                                    More Deals. <br /> <span className="text-[#00aaff]">Less Admin.</span>
                                </h2>
                                <p className="text-xl text-white/50 mb-12 max-w-md italic">Agencies using our integrated platforms spend less time on manual tasks and more time building relationships.</p>
                            ...
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 w-full">
                                {[
                                    { stat: "55%", label: "Faster lead response time via automation" },
                                    { stat: "3×", label: "More listings managed per active agent" },
                                    { stat: "70%", label: "Reduction in manual paperwork load" },
                                    { stat: "100%", label: "Data ownership—your clients, your servers" },
                                ].map((item, i) => (
