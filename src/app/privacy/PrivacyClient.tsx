            ...
            <section className="relative overflow-hidden bg-white pt-12 pb-20 lg:pt-16 lg:pb-32">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight text-black sm:text-6xl md:text-7xl lg:text-8xl mb-8 leading-[1.1] uppercase">
                            Privacy <br />
            ...
            <section className="py-20 lg:py-32 border-t border-black/[0.05] bg-black/[0.01]">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-5xl mx-auto">
                        <div className="prose prose-lg sm:prose-xl lg:prose-2xl max-w-none text-black/60 prose-headings:font-extrabold prose-headings:tracking-tight prose-headings:text-black prose-headings:uppercase prose-strong:text-black prose-li:marker:text-[#00aaff] prose-p:text-base prose-p:sm:text-xl prose-p:lg:text-2xl prose-p:leading-relaxed prose-p:mb-10 prose-p:sm:mb-14 prose-p:lg:mb-20 prose-headings:mb-8 prose-headings:sm:mb-10 prose-headings:lg:mb-14 prose-h2:text-2xl prose-h2:sm:text-3xl prose-h2:lg:text-5xl">
                            <h2 id="introduction">01. Introduction</h2>
                            <p>
                                At Mithtech Innovative Solutions (&ldquo;Mithtech&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.
                            </p>
                            ...
                            <div className="p-6 sm:p-12 rounded-2xl sm:rounded-[3rem] border border-black/[0.05] bg-black text-white not-prose hover:bg-[#111] hover:translate-y-[-4px] transition-all duration-500 mt-12 shadow-2xl">
